...
function theme() {
    ...
    function dark() {
        ...
        logo.attr('src', '/assets/images/mirahi-logo-dark.svg')
    }
    ...
    function light() {
        ...
        logo.attr('src', '/assets/images/mirahi-logo-light.svg')
    }
    ...
    toggle.prop('checked', html.hasClass('theme-dark'))
